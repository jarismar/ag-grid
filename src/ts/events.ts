...
export class Events {
    ...
    public static DEPRECATED_EVENT_BEFORE_FILTER_CHANGED = 'beforeFilterChanged'; // added by ADP-e dev team
    ...
    public static DEPRECATED_EVENT_BEFORE_SORT_CHANGED = 'beforeSortChanged'; // added by ADP-e dev team
...
export interface BeforeFilterChanged extends AgGridEvent {} // added by ADP-e
export interface FilterChangedEvent extends AgGridEvent {}
export interface FilterModifiedEvent extends AgGridEvent {}
export interface BeforeSortChanged extends AgGridEvent {} // added by ADP-e
